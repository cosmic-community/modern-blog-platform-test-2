        ...
        <div className="py-12 grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-2xl font-bold">Modern Blog</span>
            </div>
            <p className="text-gray-300 leading-relaxed max-w-md">
              A beautifully designed blog platform showcasing quality content with elegant typography and modern design. 
              Discover insightful articles across technology, travel, and lifestyle.
            </p>
          </div>
